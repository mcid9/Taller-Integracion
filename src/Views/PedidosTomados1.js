...
export default class PedidosTomados1 extends React.Component{
    item(){
        NavigationService.navigate('PedidosTomados2')
    }
    render(){
        return(
            <View style= {styles.mainContainer}>
                ...
                <View styles={styles.headerContainer}>
                    <Header
                        ...
                        centerComponent={{ text: 'Pedidos tomados', style: { color: Colors.textPrimary } }}
                        rightComponent={{
                            icon: 'magnifier', 
                            color: Colors.textPrimary, 
                            type: 'simple-line-icon', 
